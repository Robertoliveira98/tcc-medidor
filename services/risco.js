function recalculaRiscoDados(medicoes, numeroInfectados = 1, tempo = 2, ocupantes = 20, quanta = 25){
    medicoes.forEach(registro => {
        registro.risco = calculaRisco(registro.medicao, numeroInfectados, tempo, ocupantes, quanta, true)
        registro.riscoSemMascara = calculaRisco(registro.medicao, numeroInfectados, tempo, ocupantes, quanta, false)
    })
